...
int main()
{
	...
	int laco=1;
	char senhadigitada [10]="a";//string para criação da senha
	int comparacao;//comparação de valores para funcionamento da senha
	
	printf("### Bem vindo do Registro de Nomes da EBAC ###\n\n");
